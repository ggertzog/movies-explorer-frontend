...
export default function Profile({ logOut, onUpdateUser }) {
  ...
  const requirementValidity =
    !isValid ||
    (currentUserInfo.name === values.name && currentUserInfo.email === values.email);

    const toggleStateButton = requirementValidity || isRequesting;
